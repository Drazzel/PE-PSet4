...
```{r}
#NOT JUST SODAS FROM HERE ON OUT, MUST ALSO USE the potential substitutes listed on page 482.
#Specifically: Drinks with added sugar, diet sodas, bottled water, pure fruit juice, and milk.
```
